...
function initNotifications() {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (dropdown && bellElement && !bellElement.contains(e.target)) {
...
function updateNotificationDropdown(notifications) {
    ...
    notifications.forEach(notif => {
        ...
        const linkAttr = notif.link ? `onclick="handleNotificationClick(${notif.id}, '${notif.link}')"` : '';
        html += `
            <div class="notification-item unread" ${linkAttr} style="cursor: ${notif.link ? 'pointer' : 'default'}">
